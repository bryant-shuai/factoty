...
var transition = Object.freeze({
  ...
  strats.data = function (parentVal, childVal, vm) {
    if (!vm) {
      ...
      return function mergedDataFn() {
        console.log('vue data mergedDataFn          this')
        console.dir(this)
      ...
      return function mergedInstanceDataFn() {
        // instance merge
        console.log('vue data mergedInstanceDataFn          this')
        console.dir(vm)
  ...
  function defineReactive(obj, key, val) {
    ...
    Object.defineProperty(obj, key, {
      ...
      console.log('vue defineReactive get          this')
      console.dir(obj)
      ...
      set: function reactiveSetter(newVal) {
        ...
        if (setter) {
      console.log('vue defineReactive set          this')
      console.dir(obj)
...
var template = Object.freeze({
  ...
  var vFor = {
    ...
    getStagger: function getStagger(frag, index, total, type) {
      ...
      console.log('vue hook getStagger          this')
      console.dir(frag)
  ...
  function keyFilter(handler, keys) {
    ...
    return function keyHandler(e) {
      ...
      console.log('vue keyFilter          this')
      console.dir(this)
  ...
  function stopFilter(handler) {
    return function stopHandler(e) {
      e.stopPropagation();
      console.log('vue stopFilter          this')
      console.dir(this)
      return handler.call(this, e);
    };
  }
  ...
  function preventFilter(handler) {
    return function preventHandler(e) {
      e.preventDefault();
      console.log('vue preventFilter          this')
      console.dir(this)
      return handler.call(this, e);
    };
  }
  ...
  function selfFilter(handler) {
    return function selfHandler(e) {
      ...
      console.log('vue selfFilter          this')
      console.dir(this)
        return handler.call(this, e);
      }
    };
  ...
  function callActivateHooks(hooks, vm, cb) {
    ...
    var called = 0;
      console.log('vue callActivateHooks          this')
      console.dir(vm)
    ...
    function next() {
      ...
      console.log('vue callActivateHooks [1]          this')
      console.dir(this)
  ...
  function getPropDefaultValue(vm, options) {
    ...
    // call factory function for non-Function types
      ...
      console.log('vue getPropDefaultValue          this')
      console.dir(this)
  ...
  p$1.callHookWithCb = function (type) {
    ...
    if (hook) {
      ...
      console.log('vue callHookWithCb          this')
      console.dir(this.vm)
  ...
  function stateMixin (Vue) {
    ...
    Vue.prototype._initMethods = function () {
      ...
      if (methods) {
        console.log('vue._initMethods this')
        console.dir(this)
        for (var key in methods) {
          console.log('vue::::::methods:key:'+key)
          methods[key] = bind(methods[key], this);
  ...
  function eventsMixin (Vue) {
    ...
    Vue.prototype._callHook = function (hook) {
      ...
      console.log('vue _callHook          this')
      console.dir(this)
  ...
  Directive.prototype._setupParamWatcher = function (key, expression) {
    ...
    var unwatch = (this._scope || this.vm).$watch(expression, function (val, oldVal) {
      ...
      console.log('vue _setupParamWatcher          this')
      console.dir(self)
  ...
  Directive.prototype._checkStatement = function () {
    ...
    if (expression && this.acceptStatement && !isSimplePath(expression)) {
      ...
      console.log('vue _checkStatement          this')
      console.dir(scope)
  ...
  Directive.prototype._withLock = function (fn) {
    ...
    self._locked = true;
      ...
      console.log('vue _withLock          this')
      console.dir(self)
  ...
  function miscMixin (Vue) {
    ...
    Vue.prototype._resolveComponent = function (value, cb) {
      ...
      console.log('vue _resolveComponent          this')
      console.dir(this)
  ...
  var partial = {
    ...
    paramWatchers: {
      ...
      console.log('vue partial name          this')
      console.dir(this)
    ...
    insert: function insert(id) {
      ...
      console.log('vue partial bind          this')
      console.dir(this)
